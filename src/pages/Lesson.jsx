...
const Lesson = () => {
    ...
    return (
        <div>
            ...
            <h2 className='text-center font-semibold text-4xl bg-gradient-to-r from-purple-500 pb-3 to-blue-500 bg-clip-text text-transparent mb-5'>Clicking On Each Word You Can Hear the Pronunciation of the word</h2>
